...
my_cook = {
	"ZHE" : "shahe2g8d0e5eoqq55f54vkb57",
	"PHPSESSID" : "5aa72caa9a1213b0b769641d142a73d2"
	}
	...
	if sec == 1:
		...
		for qwd in range(1, 51):
			...
			if '<html><body>-<script type="text/javascript"' in dzq:
				...
				print("dir captcha azbi [zone-h.org]")
			else:
...
def spotii():
	...
	try:
		ok = raw_input("{}root@skil3r~# Entre List Email: ".format(fy,sn))
		okd = open(ok, 'r')
	except:
...
def helper4():
  ...
  ____  _  _____ _     _     _____ _   _ ____   __     ___ 
 / ___|| |/ |_ _| |   | |   | ____| | | |  _ \  \ \   / | |
 \___ \| ' / | || |   | |   |  _| | | | | |_) |  \ \ / /| |
  ___) | . \ | || |___| |___| |___| |_| |  _ <    \ V / |_|
 |____/|_|\_|___|_____|_____|_____|\___/|_| \_\    \_/  (_)
 ...
 |____/|_|\_|___|_____|_____|_____|\___/|_| \_\    \_/  (_)
                                  ...
                                  Script Name : Skilleur v1 bot ^_^
                	Greetz To : \033[ddelta killeur \033[hhamidl9re3   \033[sskilleur
                                     """)
	...
	print("""
		...
		\033[91m[9] \033[95mEmail Valid Spotify
			...
			#######################################################
			# 	  SKILLEUR |\033[91m| DONT FUCKING EDIT MY BOT        #
			#######################################################
			""")		
	try:
		qq = int(raw_input("\033[91m[-] \033[90mroot@skil3r~# \033[92mChoose Section !!\033[95m : \033[90m"))
		if qq == 1:
			clearscrn()
			print(banner)
			zonehh()
